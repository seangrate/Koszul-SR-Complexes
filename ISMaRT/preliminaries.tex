...
\subsubsection{Alexander Dualtiy}
Throughout mathematics ``duality'' is a powerful mechanism that allows one to interpret an object in two different---but virtually equivalent---ways.
For simplicial complexes, a dual can be defined, and as such, algebraic properties on one side of the duality transfer to other algebraic properties on the other side. 

\begin{definition}{\cite[Construction 62.2]{peeva_graded_2011}}
    For a simplicial complex $\Delta$, its \emph{Alexander dual} is the simplicial complex
    \begin{equation*}
        \Delta^{\vee} = \left\{ [n] \setminus \tau \, \vert \, \tau \not\in \Delta \right\}.
    \end{equation*}
\end{definition}

It turns out that $\Delta^{\vee}$ is truly dual to $\Delta$, i.e., $(\Delta^{\vee})^{\vee} = \Delta$~\cite[Exercise 62.3]{peeva_graded_2011}.
Furthermore, the facets of $\Delta$ are in bijective correspondence with the minimal monomial generators of $I_{\Delta^{\vee}}$~\cite[Exercise 62.4]{peeva_graded_2011}.
Using the Alexander dual, we get some elegant statements related to the Betti numbers of $I_\Delta$.

\begin{theorem}{\cite{terai_alexander_1999, bayer_extremal_1999}}
    For a simplicial complex $\Delta$,
    \begin{equation*}
        \pdim(S / I_{\Delta^{\vee}}) = \reg(I_\Delta).
    \end{equation*}
\end{theorem}

\begin{theorem}{\cite{eagon_resolutions_1998}}
    For a simplicial complex $\Delta$, the ideal $I_\Delta$ has a linear minimal free resolution if and only if $S / I_{\Delta^{\vee}}$ is Cohen-Macaulay.
    In other words, $I_\Delta$ has a linear minimal free resolution if and only if $\pdim(S / I_{\Delta^\vee}) = \codim(I_{\Delta^\vee})$.
\end{theorem}

\vspace*{1cm}

\noindent {\bf See Also}: Section 5.2 of~\cite{schenck_computational_2003}, Section 62 of~\cite{peeva_graded_2011}.
...
\begin{lemma}{\cite[Lemma 2.1]{migliore_weak_2020}}
...
\begin{corollary}{\cite[Corollary 2.2]{migliore_weak_2020}}
...
\begin{lemma}{\cite[Lemma 2.3]{migliore_weak_2020}}
    SOME LEMMA ABOUT REMOVING A VERTEX.
\end{lemma}

\begin{lemma}{\cite[Lemma 2.4]{migliore_weak_2020}}
...
\begin{definition}{\cite[Definition 17]{holleben_weak_2024}}
...
\begin{lemma}{\cite[Lemma 23]{holleben_weak_2024}}
...
\begin{theorem}{\cite[Theorem 54]{holleben_weak_2024}}
...
\begin{definition}{\cite[Definition 55]{holleben_weak_2024}}
...
\begin{theorem}{\cite[Theorem 58]{holleben_weak_2024}}
...
\begin{question}{\cite[Question 61]{holleben_weak_2024}}
